...
\begin{titlepage}
  ...
  \begin{center}    
    ...
    \begin{minipage}{0.75\linewidth}
      Решение уравнения БФКЛ в дипольной форме в главном
      логарифмическом приближении. Представление решения через
      собственные функции оператора Казимира конформной
      группы. Асимптотика решения при больших $s$: померон и
      оддерон. Интерсепт померона.
    \end{minipage}
    \vfill
