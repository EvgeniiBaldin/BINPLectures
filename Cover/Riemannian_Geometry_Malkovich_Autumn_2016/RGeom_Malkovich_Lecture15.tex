...
\begin{titlepage}
  ...
  \begin{center}    
    ...
    \begin{minipage}{0.6\linewidth}
      Multidimensional solutions for Einstein equation; Cartan method and components of Riemann tensor for nonholonomic frame; holonomy group; special solutions. 
    \end{minipage} 
    \vfill
