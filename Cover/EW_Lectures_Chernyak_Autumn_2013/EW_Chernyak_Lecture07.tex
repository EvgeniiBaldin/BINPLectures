...
\begin{center}
 \vfill
  \begin{minipage}{0.66\linewidth}
    Нарушение $P$"= и $CP$"=чётности. Процессы первого порядка. Вычисление
    ширины распада $W$"=бозона на электрон и антинейтрино.  Ширина
    распада $t$"=кварка на $W$"=бозон и $b$"=кварк.
  \end{minipage}
  \vfill
  % Новосибирск 2013
