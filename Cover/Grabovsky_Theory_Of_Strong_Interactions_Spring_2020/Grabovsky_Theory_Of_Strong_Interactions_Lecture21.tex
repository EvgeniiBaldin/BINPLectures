...
\begin{titlepage}
  ...
  \begin{center}    
    ...
    \begin{minipage}{0.75\linewidth}
      Струи. Траст. Алгоритмы выделения струй в $e^+e^-$ столкновениях:
      конусный и рекомбинационные "--- Durham, JADE,
      $k_t$. Быстрота. Алгоритмы выделения струй в $pp$ столкновениях:
      пример "--- $k_t$ алгоритм.
    \end{minipage}
    \vfill
