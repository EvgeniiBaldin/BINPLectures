...
\begin{titlepage}
  ...
  \begin{center}    
    ...
    \begin{minipage}{0.67\linewidth}
      Энергия взаимодействия двух статических кварков в пределе слабой
      связи. Функциональный интеграл в квантовой
      механике. Функциональный интеграл для бозонных
      полей. Производящий функционал.
    \end{minipage}
    \vfill
