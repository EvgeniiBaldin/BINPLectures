...
\begin{titlepage}
  ...
  \begin{center}    
    ...
    \begin{minipage}{0.65\linewidth}
      Киральный лагранжиан теории сильных взаимодействий. Поля
      источников.  Связь матричных элементов от кварковых полей и
      пионных полей. Связь масс лёгких кварков и массы пиона. Формула
      Гелл-Манна"--~Оакеса.
    \end{minipage}
    \vfill
