...
\begin{titlepage}
  ...
  \begin{center}    
    ...
    \begin{minipage}{0.75\linewidth}
      Уравнения ДГЛАП. Преобразование Меллина. Моменты. Решение
      уравнений ДГЛАП. Синглетные и несинглетные функции
      распределения.

      Выражение глюонной функции распределения через оператор числа
      глюонов.
    \end{minipage}
    \vfill
